...
<br><br>
**🔴Do not forget to set the Channel name, Category name, Guild id and bot token in `config.json`🔴**
<br>
<br><br>
#
<br><br>
...
<br><br>
**🔴ست کنید `config.json` فراموش نکنید که اسم چنل، اسم کتگوری، ایدی سرور و توکن ربات رو داخل🔴**
<br><br>
**با تشکر
<br><br>
-its'Hadi.Az'#1405**
